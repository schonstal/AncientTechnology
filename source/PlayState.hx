...
class PlayState extends FlxState
{
  ...
  override public function create():Void {
    ...
    FlxTween.tween(player, { y: 40 }, 1, { ease: FlxEase.quadOut, onComplete: function(t) {
      player.started = true;
  ...
  override public function update(deltaTime:Float):Void {
    if(torches.lit >= 4) {
      if(exit.alpha == 0) {
        FlxTween.tween(exit, { alpha: 0.6 }, 0.5, { ease: FlxEase.quadOut, onComplete: function(t) {
    ...
    if(!FlxG.overlap(player, startPad) && !playedSound) {
      ...
      playedSound = true;
      FlxTween.tween(stageText, { alpha: 1 }, 1, { ease: FlxEase.quartOut, onComplete: function(t) {
        new FlxTimer().start(1, function(t) {
      ...
      FlxTween.tween(FlxG.camera, 
                     ...
                     1,
                     { ease: FlxEase.quartOut, onComplete: function(t) {
                         new FlxTimer().start(1, function(t) {
                           FlxTween.tween(FlxG.camera,
